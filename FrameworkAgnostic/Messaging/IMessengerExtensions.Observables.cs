...
{
    /// <summary>
    ///     Creates an <see cref="IObservable{T}" /> instance that can be used to be notified whenever a message of a given
    ///     type is broadcast by a messenger.
    /// </summary>
    /// <typeparam name="TMessage">
    ///     The type of message to use to receive notification for through the resulting
    ///     <see cref="IObservable{T}" /> instance.
    /// </typeparam>
    /// <param name="messenger">The <see cref="IMessenger" /> instance to use to register the recipient.</param>
    /// <returns>
    ///     An <see cref="IObservable{T}" /> instance to receive notifications for <typeparamref name="TMessage" />
