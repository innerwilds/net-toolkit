    ...
    where TValue : class?
{
    ...
    public ref TValue? GetOrAddValueRef(TKey key)
    {
        ...
        while (true)
        {
            ...
            if (entries[i].HashCode == hashCode && entries[i].Key.Equals(key)) return ref entries[i].Value!;
    ...
    private unsafe ref TValue FindValue(TKey key)
    {
        ...
        do
        {
            ...
            if (entry.HashCode == hashCode && entry.Key.Equals(key)) goto ReturnFound;
    ...
    private ref int GetBucket(uint hashCode)
    {
        ...
        return ref buckets[HashHelpers.FastMod(hashCode, (uint)buckets.Length, fastModMultiplier)];
    }
