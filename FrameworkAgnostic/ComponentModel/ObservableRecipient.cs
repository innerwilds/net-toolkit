...
using FrameworkAgnostic.Messaging.Messages;
...
public abstract class ObservableRecipient : ObservableObject
{
    ...
    public bool IsActive
    {
        ...
        set
        {
            if (SetProperty(ref isActive, value, true))
            {
                if (value)
                    OnActivated();
                else
    ...
    /// </remarks>
    protected bool SetProperty<T>([NotNullIfNotNull(nameof(newValue))] ref T field, T newValue, bool broadcast,
        [CallerMemberName] string? propertyName = null)
    {
        ...
        if (propertyChanged && broadcast) Broadcast(oldValue, newValue, propertyName);
    ...
    protected bool SetProperty<T>([NotNullIfNotNull(nameof(newValue))] ref T field, T newValue,
        IEqualityComparer<T> comparer, bool broadcast, [CallerMemberName] string? propertyName = null)
    {
