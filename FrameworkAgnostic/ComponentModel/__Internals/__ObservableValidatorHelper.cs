...
namespace FrameworkAgnostic.ComponentModel.__Internals;
...
public static class __ObservableValidatorHelper
{
    ...
    [UnconditionalSuppressMessage(
        ...
        Justification =
            "This helper is called by generated code from public APIs that have the proper annotations already (and we don't want generated code to produce warnings that developers cannot fix).")]
