...
public abstract class ObservableObject : INotifyPropertyChanged, INotifyPropertyChanging
{
    ...
    {
        if (Configuration.IsINotifyPropertyChangingDisabled) return;
    ...
    protected bool SetProperty<T>([NotNullIfNotNull(nameof(newValue))] ref T field, T newValue,
        IEqualityComparer<T> comparer, [CallerMemberName] string? propertyName = null)
    {
        ...
        where TTask : Task
    {
        ...
        {
            if (callback is not null) callback(newValue);
