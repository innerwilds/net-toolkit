...
public static class ObservableGroupedCollectionExtensions
{
    ...
    ///     Thrown if <paramref name="source" /> or
    ///     <paramref name="key" /> are <see langword="null" />.
    /// </exception>
        ...
        where TKey : notnull
    {
        ...
        var group = source.FirstGroupByKeyOrDefault(key);
    ...
    /// <exception cref="Properties.Polyfills.ArgumentNullException">
    ///     Thrown if <paramref name="source" /> or
    ///     <paramref name="grouping" /> are <see langword="null" />.
    /// </exception>
    public static ObservableGroup<TKey, TElement> AddGroup<TKey, TElement>(
    ...
    /// <exception cref="Properties.Polyfills.ArgumentNullException">
    ///     Thrown if <paramref name="source" />,
    ///     <paramref name="key" /> or <paramref name="collection" /> are <see langword="null" />.
    /// </exception>
    public static ObservableGroup<TKey, TElement> AddGroup<TKey, TElement>(
        ...
        where TKey : notnull
    {
        ...
        if (source.TryGetList(out var list))
        {
            ...
            foreach (var group in list)
            {
                if (Comparer<TKey>.Default.Compare(key, group.Key) < 0) break;
        ...
        where TKey : notnull
    {
        ...
        if (source.TryGetList(out var list))
        {
            ...
            foreach (var group in list)
            {
                if (Comparer<TKey>.Default.Compare(grouping.Key, group.Key) < 0) break;
    ...
    /// <exception cref="Properties.Polyfills.ArgumentNullException">
    ///     Thrown if <paramref name="source" />,
    ///     <paramref name="key" /> or <paramref name="comparer" /> are <see langword="null" />.
    /// </exception>
    public static ObservableGroup<TKey, TElement> InsertGroup<TKey, TElement>(
        ...
        where TKey : notnull
    {
        ...
        if (source.TryGetList(out var list))
        {
            ...
            foreach (var group in list)
            {
                if (comparer.Compare(key, group.Key) < 0) break;
    ...
    /// <exception cref="Properties.Polyfills.ArgumentNullException">
    ///     Thrown if <paramref name="source" />,
    ///     <paramref name="grouping" /> or <paramref name="comparer" /> are <see langword="null" />.
    /// </exception>
    public static ObservableGroup<TKey, TElement> InsertGroup<TKey, TElement>(
        this ObservableGroupedCollection<TKey, TElement> source, IGrouping<TKey, TElement> grouping,
        ...
        where TKey : notnull
    {
        ...
        if (source.TryGetList(out var list))
        {
            ...
            foreach (var group in list)
            {
                if (comparer.Compare(grouping.Key, group.Key) < 0) break;
    ...
    /// <exception cref="Properties.Polyfills.ArgumentNullException">
    ///     Thrown if <paramref name="source" />,
    ///     <paramref name="key" />, <paramref name="comparer" /> or <paramref name="collection" /> are <see langword="null" />
    ///     .
    /// </exception>
    public static ObservableGroup<TKey, TElement> InsertGroup<TKey, TElement>(
        this ObservableGroupedCollection<TKey, TElement> source, TKey key, IComparer<TKey> comparer,
        ...
        where TKey : notnull
    {
        ...
        else if (group.TryGetList(out var list))
        {
            var index = 0;

            foreach (var element in list)
            {
                if (Comparer<TElement>.Default.Compare(item, element) < 0) break;
    ...
    /// <exception cref="Properties.Polyfills.ArgumentNullException">
    ///     Thrown if <paramref name="source" />,
    ///     <paramref name="key" />, <paramref name="keyComparer" /> or <paramref name="itemComparer" /> are
    ///     <see langword="null" />.
    /// </exception>
    public static ObservableGroup<TKey, TElement> InsertItem<TKey, TElement>(
        ...
        where TKey : notnull
    {
        ...
        else if (group.TryGetList(out var list))
        {
            ...
            foreach (var element in list)
            {
                if (itemComparer.Compare(item, element) < 0) break;
        ...
        else
        {
                ...
                IComparer<TElement> comparer)
            {
                ...
                foreach (var element in source)
                {
                    if (comparer.Compare(item, element) < 0) break;
