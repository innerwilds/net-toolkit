    ...
    where TKey : notnull
{
    ...
    IEnumerable<TElement> ILookup<TKey, TElement>.this[TKey key]
    {
        get
        {
            ...
            if (key is not null) result = FirstGroupByKeyOrDefault(key);
    ...
    private void OnSourceCollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
        ...
        var items = (ObservableCollection<ReadOnlyObservableGroup<TKey, TElement>>)Items;
        ...
        switch (e.Action)
        {
            ...
            case NotifyCollectionChangedAction.Add:
                ...
                {
                    var newItem = (ObservableGroup<TKey, TElement>)e.NewItems![0]!;
            ...
            case NotifyCollectionChangedAction.Remove:
                ...
                else if (e.OldItems!.Count > 1) ThrowNotSupportedExceptionForRangeOperation();
            ...
            case NotifyCollectionChangedAction.Replace:
                ...
                {
                    var replacedItem = (ObservableGroup<TKey, TElement>)e.NewItems![0]!;
            ...
            case NotifyCollectionChangedAction.Move:
                ...
                else if (e.OldItems!.Count > 1 || e.NewItems!.Count > 1) ThrowNotSupportedExceptionForRangeOperation();
