...
public sealed class Ioc : IServiceProvider
{
        ...
        where T : class
    {
        ...
        if (service is null) ThrowInvalidOperationExceptionForUnregisteredType();
    ...
    public void ConfigureServices(IServiceProvider serviceProvider)
    {
        ...
        var oldServices = Interlocked.CompareExchange(ref this.serviceProvider, serviceProvider, null);

        if (oldServices is not null) ThrowInvalidOperationExceptionForRepeatedConfiguration();
    }
